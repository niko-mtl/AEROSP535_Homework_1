...
mf_to_m0 = np.exp(-delta_V/g0/Isp)
lambdaa = mf_to_m0

mp_to_m0 = 1- np.exp(-delta_V/g0/Isp)
zeta = mp_to_m0
m0 = mpl/lambdaa + mpl
...
print("Apollo 10")
print(f'm_total_i     {m0}')
print(f'm_total_final {mf}')
print(f'm_structure   {ms}')
print(f'm_payload     {mpl}')
print(f'm_fuel        {mp}')
print()
...
def calculate_alpha_for_result(result):
    ...
    print(f'delta_v2 {delta_V2}')
    print(f'delta_v2 {delta_V3}')
    print()
    print(f'epslion_1 {epsilon_1}')
    print(f'epslion_2 {epsilon_2}')
    print(f'epslion_3 {epsilon_3}')
    print()
    print(f'ISP_1 {result[0][3]}')
    print(f'ISP_2 {result[1][3]}')
    print(f'ISP_3 {result[2][3]}')
    print()
    print(f'lambda_1 {result[0][-2]}')
    print(f'lambda_2 {result[1][-2]}')
    print(f'lambda_3 {result[2][-2]}')
    print()
    print(f'm01 {result[0][-1]}')
    print(f'm02 {result[1][-1]}')
    print(f'm03 {result[2][-1]}')
